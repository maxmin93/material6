...
export class D3GraphComponent implements AfterViewInit {
  ...
  drawGraph(){
    ...
    var link = svg.append("g")
          ...
          .attr("stroke-width", function(d) { 
            // console.log( d, d.value, Math.sqrt(d.value) );
  ...
  openBottomSheet(): void {
    const bottomSheetRef = this.bottomSheet.open(D3MetaSheetComponent, {
      ariaLabel: 'Share on social media',
      panelClass: 'custom-width',
      data: { strength: this.strengthValue, fn: this.simulation }
    });

    bottomSheetRef.afterDismissed().subscribe((x) => {
      console.log('Bottom sheet has been dismissed.', x, this.strengthValue);
    });
